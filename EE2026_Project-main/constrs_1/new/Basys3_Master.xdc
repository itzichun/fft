...
##Pmod Header JCADC
##Sch name = XA1_P
#set_property PACKAGE_PIN J3 [get_ports {JCADC[0]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[0]}]
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports {JCADC[1]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[1]}]
##Sch name = XA3_P
#set_property PACKAGE_PIN M2 [get_ports {JCADC[2]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[2]}]
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports {JCADC[3]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[3]}]
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {JCADC[4]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[4]}]
##Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports {JCADC[5]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[5]}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {JCADC[6]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[6]}]
##Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {JCADC[7]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JCADC[7]}]
